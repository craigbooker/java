...
/**
 * An activity representing a list of BlogPosts. This activity has different
 * presentations for handset and tablet-size devices. On handsets, the activity
 * presents a list of items, which when touched, lead to a
 * {@link BlogPostDetailActivity} representing item details. On tablets, the
 * activity presents the list of items and item details side-by-side using two
 * vertical panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link BlogPostListFragment} and the item details (if present) is a
 * {@link BlogPostDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link BlogPostListFragment.Callbacks} interface to listen for item
 * selections.
 */
public class BlogPostListActivity extends FragmentActivity implements
		BlogPostListFragment.Callbacks {
	...
	/**
	 * Callback method from {@link BlogPostListFragment.Callbacks} indicating
	...
	public void onItemSelected(String id) {
		if (mTwoPane) {
			...
			getSupportFragmentManager().beginTransaction()
					.replace(R.id.blogpost_detail_container, fragment).commit();
