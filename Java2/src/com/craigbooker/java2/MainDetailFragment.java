...
import com.craigbooker.java2.dummy.DummyContent;
 ...
 * tablets) or a {@link MainDetailActivity} on handsets.
 */
public class MainDetailFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		if (mItem != null) {
			((TextView) rootView.findViewById(R.id.main_detail)).setText(mItem.description);
		}
