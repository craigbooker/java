...
/**
 * An activity representing a list of ServiceCategories. This activity has
 ...
 * {@link ServiceCategoryDetailActivity} representing item details. On tablets,
 * the activity presents the list of items and item details side-by-side using
 * two vertical panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link ServiceCategoryListFragment} and the item details (if present) is a
 * {@link ServiceCategoryDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link ServiceCategoryListFragment.Callbacks} interface to listen for item
 * selections.
 */
public class ServiceCategoryListActivity extends FragmentActivity implements
	...
	/**
	 * Callback method from {@link ServiceCategoryListFragment.Callbacks}
	...
	public void onItemSelected(String id) {
		if (mTwoPane) {
			...
			Intent detailIntent = new Intent(this,
					ServiceCategoryDetailActivity.class);
			detailIntent
					.putExtra(ServiceCategoryDetailFragment.ARG_ITEM_ID, id);
