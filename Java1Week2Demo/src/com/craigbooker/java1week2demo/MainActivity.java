package com.craigbooker.java1week2demo;


import java.util.ArrayList;
import java.util.HashMap;

import com.craigbooker.ecom.Money;
import com.craigbooker.ecom.Phone;
import com.craigbooker.ecom.Product;
...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		products.add(new Phone("Galaxy S 3", 00.99));
