...
/**
 * An activity representing a list of ServiceTypes. This activity has different
 * presentations for handset and tablet-size devices. On handsets, the activity
 * presents a list of items, which when touched, lead to a
 * {@link ServiceTypeDetailActivity} representing item details. On tablets, the
 * activity presents the list of items and item details side-by-side using two
 * vertical panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link ServiceTypeListFragment} and the item details (if present) is a
 * {@link ServiceTypeDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link ServiceTypeListFragment.Callbacks} interface to listen for item
 * selections.
 */
public class ServiceTypeListActivity extends FragmentActivity implements
		ServiceTypeListFragment.Callbacks {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (findViewById(R.id.servicetype_detail_container) != null) {
			...
			((ServiceTypeListFragment) getSupportFragmentManager()
	...
	public void onItemSelected(String id) {
		if (mTwoPane) {
			...
			Intent detailIntent = new Intent(this,
					ServiceTypeDetailActivity.class);
